...
struct FavPassedTimeView_Previews: PreviewProvider {
    static var previews: some View {
        FavPassedTimeView(event: EventModel.example, timer: Publishers.Autoconnect<Timer.TimerPublisher>(upstream: .init(interval: 1.0, runLoop: .main, mode: .common)), timerIsRunning: .constant(true))
    }
}
